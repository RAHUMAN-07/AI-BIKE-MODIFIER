...
export const BIKE_PARTS: Record<string, { displayName: string; icon: string }> = {
  ...
  front_disc: { displayName: 'Front Brake Disc', icon: '🟠' },
  rear_disc: { displayName: 'Rear Brake Disc', icon: '🟠' },
  front_caliper: { displayName: 'Front Caliper', icon: '🧰' },
  rear_caliper: { displayName: 'Rear Caliper', icon: '🧰' },  winglet_left: { displayName: 'Left Winglet', icon: '🛩️' },
  winglet_right: { displayName: 'Right Winglet', icon: '🛩️' },  mudguard_front: { displayName: 'Front Mudguard', icon: '🛡️' },
  mudguard_rear: { displayName: 'Rear Mudguard', icon: '🛡️' },
  chain_cover: { displayName: 'Chain Cover', icon: '⛓️' },
  radiator: { displayName: 'Radiator', icon: '❄️' },
  swingarm: { displayName: 'Swingarm', icon: '𐌕' },
  subframe: { displayName: 'Subframe', icon: '🧱' },
  footpeg_left: { displayName: 'Left Footpeg', icon: '🦵' },
  footpeg_right: { displayName: 'Right Footpeg', icon: '🦵' },
  air_intake: { displayName: 'Air Intake', icon: '🌀' },
  engine: { displayName: 'Engine', icon: '⚙️' },
  frame: { displayName: 'Frame', icon: '🏗️' },
  rear_sprocket: { displayName: 'Rear Sprocket', icon: '⚙️' },
  chain: { displayName: 'Drive Chain', icon: '⛓️' },
  fork_guard_left: { displayName: 'Left Fork Guard', icon: '🛡️' },
  fork_guard_right: { displayName: 'Right Fork Guard', icon: '🛡️' },
  steering_damper: { displayName: 'Steering Damper', icon: '🔧' },
};
...
export const STYLE_VARIANTS: Record<string, StyleVariant[]> = {
  default: [
    ...
    { id: 'race', name: 'Race Livery', tag: 'Track', imageUrl: null, description: 'Bold red-white race stripes and winglets' },
