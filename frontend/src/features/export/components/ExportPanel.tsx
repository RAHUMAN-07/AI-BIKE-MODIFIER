...
export default function ExportPanel() {
  ...
  const handleExport = useCallback((format: string) => {
    ...
    setTimeout(() => {
      ...
      const messages: Record<string, string> = {
        mp4: '360° Video export — connect rendering backend for turntable videos.',
        glb: '3D GLB download — feature available with backend models.',
  ...
  const exportOptions = [
    { id: 'png', name: 'High-Res Image', desc: 'PNG render from current view', icon: '🖼️' },
    { id: 'mp4', name: '360° Video', desc: 'Auto-rotate turntable video', icon: '🎬' },
    { id: 'glb', name: '3D Model File', desc: 'Download modified GLB mesh', icon: '📦' },
    { id: 'share', name: 'Share Link', desc: 'Copy shareable preview link', icon: '🔗' },
  ];
